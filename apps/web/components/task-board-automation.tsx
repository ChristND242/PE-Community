...
type AutomationRecipient = { id: string; name: string; avatarUrl?: string | null; dicebearStyle?: string | null; dicebearSeed?: string | null; role?: string | null; source: AutomationRecipientSource };
