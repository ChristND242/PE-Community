...
export function MemberDashboardView({
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(94,210,156,0.22),transparent_34%),linear-gradient(135deg,rgba(8,13,12,0.96),rgba(6,78,59,0.42)_58%,rgba(4,12,11,0.96))] p-6 shadow-2xl shadow-black/25">
...
function StreakBoardCard({ board, t }: { board: MemberDashboardStreakBoard; t: ReturnType<typeof useI18n>['t'] }) {
  ...
  return (
    <section className="relative overflow-hidden rounded-[2rem] border border-emerald-300/15 bg-[radial-gradient(circle_at_top_left,rgba(16,185,129,0.22),transparent_34%),radial-gradient(circle_at_bottom_right,rgba(45,212,191,0.14),transparent_32%),linear-gradient(135deg,rgba(2,6,23,0.96),rgba(6,78,59,0.42))] shadow-2xl shadow-black/20">
