...
type MemberEventTask = {
  ...
  dueDate?: string | null;
  sortOrder: number;
  assignee?: { id: string; name: string; role?: string | null; avatarUrl?: string | null; dicebearStyle?: string | null; dicebearSeed?: string | null } | null;
  assignees: Array<{ id: string; name: string; role?: string | null; avatarUrl?: string | null; dicebearStyle?: string | null; dicebearSeed?: string | null }>;
